  ...
  <html>
    ...
    <div class="nav-wrapper">
	 ...
	 <ul class="right hide-on-med-and-down">
		<li><a href="pr.html"><i class="material-icons">search</i></a></li>
        <li><a href="pr.html"><i class="material-icons">refresh</i></a></li>
		</ul>
    </div>
  </nav>
   ...
   <ul>
    ...
    <div class="card horizontal">
      <div class="card-image"   >
        <img style= "width:500px; height:500px" src="http://www.zerorezphoenix.com/wp/phoenix/wp-content/uploads/2016/01/bigstock-Colored-Bar-Graph-With-Red-Arr-69412774.jpg" >
      </div>
      <div class="card-stacked red accent-1">
        <div class="card-content red accent-1" style="width:800px;">
